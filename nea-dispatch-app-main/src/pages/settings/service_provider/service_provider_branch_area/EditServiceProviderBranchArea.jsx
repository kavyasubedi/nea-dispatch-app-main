...
export default function EditServiceProviderBranchArea() {
  const { id } = useParams();
  ...
  function fetchOltData() {
    api
      ...
      .then((res) => {
        const filteredData = res.data.filter(
          (item) => item.id && item.id == parseInt(formValues.branch.id)
        );
        console.log("Filtered Data:", filteredData);
  ...
  function storeData() {
    api
      .put("/areas/" + parseInt(id), formValues, {
        headers: {},
      })
      .then((res) => {
            ...
            <div className="col-12 col-md-6 col-lg-3">
              ...
              >
                {error.olt === null || error.olt === "" ? (
                  <span className="text-secondary small">Change Olt.</span>
                ) : (
            ...
            <div className="col-12 col-md-6 col-lg-3">
              ...
              >
                {error.name === null || error.name === "" ? (
                  <span className="text-secondary small">Edit Area Name.</span>
                ) : (
            ...
            <div className="col-12 col-md-6 col-lg-3">
              ...
              >
                {error.code === null || error.code === "" ? (
                  <span className="text-secondary small">Edit Area Code.</span>
                ) : (
